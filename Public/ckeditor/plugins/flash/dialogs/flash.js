...
(function() {
    ...
    CKEDITOR.dialog.add("flash", function(a) {
        var l = !a.config.flashEmbedTagOnly,
            ...
            '\x3cbr\x3e\x3cdiv id\x3d"cke_FlashPreviewLoader' + CKEDITOR.tools.getNextNumber() +
            ...
            CKEDITOR.tools.getNextNumber() + '" class\x3d"FlashPreviewBox"\x3e\x3c/div\x3e\x3c/div\x3e';
        return {
            ...
            onOk: function() {
                var e =
                    ...
                    d = null,
                    b = null;
                this.fakeImage ? (e = this.objectNode, d = this.embedNode) : (l && (e = CKEDITOR.dom.element
                    .createFromHtml("\x3ccke:object\x3e\x3c/cke:object\x3e", a.document), e.setAttributes({
                        classid: "clsid:d27cdb6e-ae6d-11cf-96b8-444553540000",
                        codebase: "http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version\x3d6,0,40,0"
                    })), k && (d = CKEDITOR.dom.element.createFromHtml(
                        "\x3ccke:embed\x3e\x3c/cke:embed\x3e", a.document), d.setAttributes({
                        type: "application/x-shockwave-flash",
                        pluginspage: "http://www.macromedia.com/go/getflashplayer"
                    }),
                    e && d.appendTo(e)));
                if (e)
                    for (var b = {}, c = e.getElementsByTag("param", "cke"), f = 0, h = c.count(); f <
                        h; f++) b[c.getItem(f).getAttribute("name")] = c.getItem(f);
                c = {};
                f = {};
                ...
                e.setAttributes(f);
                e.setStyles(c);
                this.fakeImage ? (e.replace(this.fakeImage), a.getSelection().selectElement(e)) : a.insertElement(
                    e)
            },
            onHide: function() {
                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            required: !0,
                            validate: CKEDITOR.dialog.validate.notEmpty(a.lang
                                .flash.validateSrc),
                            setup: b,
                            commit: c,
                            onLoad: function() {
                    ...
                    children: [{
                        ...
                        validate: CKEDITOR.dialog.validate.htmlLength(a.lang.common
                            .invalidHtmlLength.replace("%1", a.lang.common.width)
                        ),
                        setup: b,
                        commit: c
                    }, {
                        ...
                        validate: CKEDITOR.dialog.validate.htmlLength(a.lang.common
                            .invalidHtmlLength.replace("%1", a.lang.common.height)
                        ),
                        setup: b,
                        commit: c
                    }, {
