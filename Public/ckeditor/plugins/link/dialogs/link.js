        ...
        return {
                ...
                elements: [{
                    ...
                    onChange: function() {
                        var a = this.getDialog(),
                            ...
                            f = f && f.hidden;
                        "url" == r ? (c.config.linkShowTargetTab && a.showPage("target"),
                            f || a.showPage("upload")) : (a.hidePage("target"),
                            f || a.hidePage("upload"));
                        for (f = 0; f < b.length; f++) {
                            var h = a.getContentElement("info", b[f]);
                            h && (h = h.getElement().getParent().getParent(), b[f] == r +
                                "Options" ? h.show() : h.hide())
                        }
                        a.layout()
                    },
                    setup: function(a) {
                        ...
                        children: [{
                            ...
                            validate: function() {
                                ...
                                return a.getContentElement("info",
                                        "linkType") && "url" != a.getValueOf(
                                        "info", "linkType") ? !0 : !c.config
                                    .linkJavaScriptLinksAllowed &&
                                    /javascript\:/.test(this.getValue()) ?
                                    (alert(g.invalidValue), !1) : this.getDialog()
                                    .fakeObj ? !0 : CKEDITOR.dialog.validate
                                    .notEmpty(b.noUrl).apply(this)
                            },
                            setup: function(a) {
                                this.allowOnChange = !1;
                    ...
                    setup: function() {
                        this.getDialog().getContentElement("info", "linkType") || this.getElement()
                            .hide()
                    }
                }, {
                    type: "vbox",
                    ...
                    children: [{
                        ...
                        validate: function() {
                            ...
                            return a.getContentElement("info", "linkType") &&
                                ...
                                CKEDITOR.dialog.validate.notEmpty(b.noEmail).apply(
                                    this) : !0
                        },
                        setup: function(a) {
                            a.email &&
                            ...
                            (a = this.getDialog().getContentElement("info",
                                "linkType")) && "email" == a.getValue() && this
                                .select()
                        },
                        commit: function(a) {
                            a.email || (a.email = {});
                    ...
                    children: [{
                        ...
                        setup: function(a) {
                            ...
                            (a = this.getDialog().getContentElement("info",
                                "linkType")) && "tel" == a.getValue() && this.select()
                        },
                        commit: function(a) {
                            a.tel = this.getValue()
                        }
                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            label: b.download,
                            setup: function(a) {
                                void 0 !== a.download && this.setValue(
                                    "checked", "checked")
                            },
                            commit: function(a) {
            ...
            onShow: function() {
                var a = this.getParentEditor(),
                    ...
                    h = f[0] || null;
                h && h.hasAttribute("href") && (b.getSelectedElement() || b.isInTable() || b.selectElement(
                    h));
            ...
            onOk: function() {
                ...
                if (this._.selectedElements.length) {
                    ...
                    for (k = 0; k < b.length; k++) {
                        ...
                        else if (d == l || "email" == a.type && -1 != l.indexOf("@")) e = "email" == a.type ?
                            a.email.address : g.set["data-cke-saved-href"];
                        e && h.setText(e);
                        f.push(p(c, h))
                    }
                    ...
                    for (l = 0; l < g.length; l++) {
                        ...
                        d.collapsed ? (e = new CKEDITOR.dom.text(a.linkText ||
                                ...
                                c.document), d.insertNode(e), d.selectNodeContents(e)) : q !== a.linkText &&
                            (e = new CKEDITOR.dom.text(a.linkText, c.document), d.shrink(CKEDITOR.SHRINK_TEXT),
                                c.editable().extractHtmlFromRange(d), d.insertNode(e));
                        e = d._find("a");
