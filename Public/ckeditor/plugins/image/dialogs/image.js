    ...
    var u = function(d, k) {
        ...
        function g(a) {
            if (!v) {
                ...
                if (c) {
                    this.commit(1, c);
                    a = [].concat(a);
                    for (var d = a.length, h, e = 0; e < d; e++)(h = b.getContentElement.apply(b, a[e].split(
                        ":"))) && h.setup(1, c)
                }
                v = 0
            }
        ...
        var l = /^\s*(\d+)((px)|\%)?\s*$/i,
            ...
            z = function() {
                var a = this.getValue(),
                    ...
                    c = a.match(l);
                c && ("%" == c[2] && m(b, !1), a = c[1]);
                b.lockRatio && (c = b.originalElement, "true" == c.getCustomData("isReady") && ("txtHeight" ==
                    this.id ? (a && "0" != a && (a = Math.round(a / c.$.height * c.$.width)), isNaN(a) ||
                        b.setValueOf("info", "txtWidth", a)) : (a && "0" != a && (a = Math.round(a / c.$
                        .width * c.$.height)), isNaN(a) || b.setValueOf("info", "txtHeight", a))));
                e(b)
            },
            e = function(a) {
            ...
            v, m = function(a,
                ...
                CKEDITOR.env.hc && d.getChild(0).setHtml(a.lockRatio ? CKEDITOR.env.ie ? "■" : "▣" : CKEDITOR.env
                    .ie ? "□" : "▢");
                return a.lockRatio
            },
            A = function(a, b) {
        ...
        return {
            ...
            onShow: function() {
                ...
                c && (this.linkElement = c, this.addLink = this.linkEditMode = !0, a = c.getChildren(), 1 ==
                    a.count() && (d = a.getItem(0), d.type == CKEDITOR.NODE_ELEMENT && (d.is("img") ||
                        d.is("input")) && (this.imageElement = a.getItem(0), this.imageElement.is(
                            "img") ? this.imageEditMode =
                        "img" : this.imageElement.is("input") && (this.imageEditMode = "input"))),
                    "image" == k && this.setupContent(2, c));
                if (this.customImageElement) this.imageEditMode = "img", this.imageElement = this.customImageElement,
                    delete this.customImageElement;
                else if (b && "img" == b.getName() && !b.data("cke-realelement") || b && "input" == b.getName() &&
                    "image" == b.getAttribute("type")) this.imageEditMode = b.getName(), this.imageElement =
                    b;
                this.imageEditMode && (this.cleanImageElement = this.imageElement, this.imageElement = this
                    .cleanImageElement.clone(!0,
                        !0), this.setupContent(1, this.imageElement));
                m(this, !0);
                CKEDITOR.tools.trim(this.getValueOf("info", "txtUrl")) || (this.preview.removeAttribute(
                    "src"), this.preview.setStyle("display", "none"))
            },
            onOk: function() {
                if (this.imageEditMode) {
                    var a = this.imageEditMode;
                    "image" == k && "input" == a && confirm(d.lang.image.button2Img) ? (this.imageElement =
                            d.document.createElement("img"), this.imageElement.setAttribute("alt", ""), d.insertElement(
                                this.imageElement)) : "image" != k && "img" == a && confirm(d.lang.image.img2Button) ?
                        (this.imageElement =
                ...
                } else "image" == k ? this.imageElement = d.document.createElement("img") : (this.imageElement =
                        d.document.createElement("input"), this.imageElement.setAttribute("type", "image")),
                ...
                this.imageEditMode ? !this.linkEditMode && this.addLink ? (d.insertElement(this.linkElement),
                        this.imageElement.appendTo(this.linkElement)) : this.linkEditMode && !this.addLink &&
                    (d.getSelection().selectElement(this.linkElement), d.insertElement(this.imageElement)) :
                    this.addLink ? this.linkEditMode ? this.linkElement.equals(d.getSelection().getSelectedElement()) ?
            ...
            onLoad: function() {
                ...
                this.getContentElement("info", "ratioLock") && (this.addFocusable(a.getById(x), 5), this.addFocusable(
                    a.getById(r), 5));
            ...
            onHide: function() {
                ...
                this.originalElement && (this.originalElement.removeListener("load",
                    t), this.originalElement.removeListener("error", f), this.originalElement.removeListener(
                    "abort", f), this.originalElement.remove(), this.originalElement = !1);
            ...
            contents: [{
                ...
                elements: [{
                        ...
                        children: [{
                            ...
                            widths: ["280px", "110px"],
                            align: "right",
                            className: "cke_dialog_image_url,nime",
                            children: [{
                                id: "txtUrl",
                                type: "text",
                                ...
                                onChange: function() {
                                    ...
                                    if (0 <
                                        ...
                                        var a = this.getDialog(),
                                            c = a.originalElement;
                                        a.preview && a.preview.removeStyle(
                                            "display");
                                        ...
                                        a.preview && (w.setAttribute("src", b),
                                            a.preview.setAttribute("src", w
                                                .$.src), e(a))
                                    } else a.preview && (a.preview.removeAttribute(
                                        "src"), a.preview.setStyle(
                                        "display", "none"))
                                },
                                setup: function(a, b) {
                                    if (1 == a) {
                                ...
                                commit: function(a, b) {
                                    1 == a && (this.getValue() || this.isChanged()) ?
                                        ...
                                        ) : 8 == a && (b.setAttribute("src", ""),
                                            b.removeAttribute("src"))
                                },
                                validate: CKEDITOR.dialog.validate.notEmpty(d.lang.image
                                    .urlMissing)
                            }, {
                                type: "button",
                                id: "browse",
                    ...
                    },
                    {
                        ...
                        commit: function(a, b) {
                            1 == a ? (this.getValue() || this.isChanged()) && b.setAttribute(
                                "alt", this.getValue()) : 4 == a ? b.setAttribute("alt",
                        ...
                        children: [{
                                        ...
                                        commit: function(a, b) {
                                            ...
                                            1 == a || 4 == a ? (isNaN(c) ?
                                                ...
                                                (b.removeAttribute("border"),
                                                    b.removeStyle(
                                                        "border-width"), b.removeStyle(
                                                        "border-style"), b.removeStyle(
                                                        "border-color"))
                                        }
                                    }, {
                                        type: "text",
                                        ...
                                        commit: function(a, b) {
                                            ...
                                            1 == a || 4 == a ? (isNaN(c) ?
                                                    ...
                                                    b.removeAttribute(
                                                        "hspace")) :
                                                8 == a && (b.removeAttribute(
                                                    "hspace"), b.removeStyle(
                                                    "margin-left"), b.removeStyle(
                                                    "margin-right"))
                                        }
                                    }, {
                                        type: "text",
                            ...
                            children: [{
                                ...
                                id: "htmlPreview",
                                style: "width:95%;",
                                html: "\x3cdiv\x3e" + CKEDITOR.tools.htmlEncode(d.lang
                                        .common.preview) +
                                    '\x3cbr\x3e\x3cdiv id\x3d"' + n +
                                    ...
                                    D + '"\x3e\x3cimg id\x3d"' + C +
                                    '" alt\x3d"" /\x3e\x3c/a\x3e' + (d.config.image_previewText ||
                ...
                elements: [{
                    ...
                    commit: function(a, b) {
                        if (2 == a && (this.getValue() || this.isChanged())) {
                            ...
                            this.getValue() ||
                                !d.config.image_removeLinkByEmptyURL ? this.getDialog().addLink = !
                                0 : this.getDialog().addLink = !1
                        }
                    }
                }, {
                    type: "button",
                    id: "browse",
                    className: "cke_dialog_image_browse,nime",
                    filebrowser: {
                        action: "Browse",
                        target: "Link:txtUrl",
                    ...
                    commit: function(a, b) {
                        2 == a && (this.getValue() || this.isChanged()) && b.setAttribute(
                ...
                elements: [{
                    ...
                    },
                    {
                        ...
                        children: [{
                            ...
                            commit: function(a, b) {
                                1 == a ? (this.getValue() || this.isChanged()) && b.setAttribute(
                                    "title", this.getValue()) : 4 == a ? b.setAttribute(
                                    "title", this.getValue()) : 8 == a && b.removeAttribute(
                                    "title")
                            }
                        }]
                    }, {
