<?php
require_once "Application/Payment/Weixin/Base/WxPay.Exception.php";
require_once "Application/Payment/Weixin/Base/WxPay.Config.Interface.php";
require_once "Application/Payment/Weixin/Base/WxPay.Data.php";
...
class WxPayApi
{
	...
	public static function unifiedOrder($config, $inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetSpbill_create_ip(getClientIp());//终端ip $_SERVER['REMOTE_ADDR']
	 ...
	 * @return 成功时返回，其他抛异常
	 */
	public static function withdraw($config, $inputObj, $timeOut = 6)
	{
