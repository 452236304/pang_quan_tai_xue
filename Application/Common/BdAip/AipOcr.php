...
class AipOcr extends AipBase {
	public function __construct(){
		...
		$this->appId = trim('18588745');
	
		$this->apiKey = trim('oivbrOTvultvXrPqQZIjloVR');
   
		$this->secretKey = trim('dmW7vGTLDfqd5nDXqfjaMv1tNy4FIXtS');
    ...
    public function idcard($image, $idCardSide, $options=array()){
        ...
        $data['image'] = $image;//base64_encode($image);
