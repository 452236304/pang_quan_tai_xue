                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content row">
                            ...
                            <div class="col-sm-5 row">
                                <form id="search-form" method="post" class="form-horizontal" action="<?php echo U('listad');?>">
                                    <div class="input-group">
                                        <input type="text" placeholder="姓名 / 手机号码" name="keyword" class="form-control"
                            ...
                            <table class="table table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="100" class="TC">年龄</th>
										<th width="100" class="TC">现居区域</th>
										<th width="100" class="TC">工作经历</th>
										<th width="100" class="TC">护理员证</th>
                                        <th width="200" class="TC">备注</th>
                                        <th width="150" class="TC">申请日期</th>
                                ...
                                <tbody>
                                    <?php if(is_array($data)): $n = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($n % 2 );++$n;?><tr>
                                            ...
                                            <td align="center"><?php echo ($vo["birth"]); ?></td>
											<td align="center"><?php echo ($vo["address"]); ?></td>
											<td align="center"><?php echo ($vo["experience"]); ?></td>
											<td align="center"><?php echo ($vo["certificates"]); ?></td>
                                            ...
                                            <td class="text-navy" align="center">
                                                <a href="javascript:;" data-url="<?php echo U('ApplyJob/delad','id='.$vo['id'].'&p='.$map['p']);?>"
                                                    class="checkDel">删除</a>
                                            </td>
