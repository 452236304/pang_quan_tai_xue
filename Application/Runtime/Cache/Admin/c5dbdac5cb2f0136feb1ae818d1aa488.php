        	...
        	<div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('Sysuser/modifypassword','doinfo=modifypassword&id='.$userinfo['id']);?>">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">用户名：</label>
                                <div class="col-sm-10"><?php echo ($userinfo["username"]); ?></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="truename" value="<?php echo ($userinfo["truename"]); ?>" required="">
                                </div>
                            </div>
                             <div class="hr-line-dashed"></div>
                            <div class="form-group">
