        	...
        	<div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('Sysuser/modifyuser','doinfo=modifyuser&id='.$userinfo['id']);?>">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">所属用户组：</label>

                                <div class="col-sm-10">
                                <select data-placeholder="选择分组..." class="chosen-select form-control" style="width:350px;" tabindex="2" name="typeid">
                                    <option value="">选择所属分组</option>
                                    <?php if(is_array($userclass)): $i = 0; $__LIST__ = $userclass;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php echo (getSelect(select,$vo["id"],$userinfo["typeid"])); ?>><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="username" value="<?php echo ($userinfo["username"]); ?>" required="">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                <select data-placeholder="状态..." class="chosen-select form-control" style="width:350px;" tabindex="2" name="ispass">
                                    <option value="0" <?php echo (getSelect(select,$userinfo["ispass"],0)); ?>>禁用</option>
                                    <option value="1" <?php echo (getSelect(select,$userinfo["ispass"],1)); ?>>启用</option>
                                </select>
                            </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" placeholder="密码不修改则留空" class="form-control" name="password">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" placeholder="密码不修改则留空" class="form-control" name="repassword">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <button class="btn btn-white" type="button" onclick="location.href='<?php echo U('Sysuser/listuser');?>'">返回</button>
                                </div>
                            </div>
                        </form>
                    </div>
