            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <button class="btn btn-primary" type="button" onclick="location.href='<?php echo U('Sysuser/modifyuserclass');?>'">＋增加</button>
                    </div>
                </div>
            </div>
        	<div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                        	<?php if(is_array($userclass)): $i = 0; $__LIST__ = $userclass;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    <td><?php echo ($vo["title"]); ?></td>
                                    <td class="text-navy">
										<a href="<?php echo U('Sysuser/modifyuserclass','id='.$vo['id']);?>" >修改</a> 
										<a href="javascript:;" data-url="<?php echo U('Sysuser/deluserclass','id='.$vo['id']);?>" class="checkDel">删除</a>
                                    </td>
