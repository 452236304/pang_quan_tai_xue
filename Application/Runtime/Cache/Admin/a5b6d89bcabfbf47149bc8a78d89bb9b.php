        	...
        	<div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('Sysuser/sysconfig','doinfo=sysconfig&id='.$datainfo['id']);?>">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">标题：</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="title" value="<?php echo ($datainfo["title"]); ?>" required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="keyword" value="<?php echo ($datainfo["keyword"]); ?>" required="">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="description" value="<?php echo ($datainfo["description"]); ?>" required="">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="author" value="<?php echo ($datainfo["author"]); ?>" required="">
                                </div>
                            </div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-sm-2 control-label">开关（苹果审核时开启 苹果审核结束关闭）：</label>
								<div class="col-sm-10 radio i-checks">
									<label><input type="radio" name="off" value="0" <?php echo (getSelect(radio,$offconfig["off"],0)); ?>><i></i>关</label>
									<label><input type="radio" name="off" value="1" <?php echo (getSelect(radio,$offconfig["off"],1)); ?>><i></i>开</label>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-sm-2 control-label">服务端开关（苹果审核时开启 苹果审核结束关闭）：</label>
								<div class="col-sm-10 radio i-checks">
									<label><input type="radio" name="sysoff" value="0" <?php echo (getSelect(radio,$offconfig["sysoff"],0)); ?>><i></i>关</label>
									<label><input type="radio" name="sysoff" value="1" <?php echo (getSelect(radio,$offconfig["sysoff"],1)); ?>><i></i>开</label>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-sm-2 control-label">小程序开关（小程序审核时开启 小程序审核结束关闭）：</label>
								<div class="col-sm-10 radio i-checks">
									<label><input type="radio" name="xcxoff" value="0" <?php echo (getSelect(radio,$offconfig["xcxoff"],0)); ?>><i></i>关</label>
									<label><input type="radio" name="xcxoff" value="1" <?php echo (getSelect(radio,$offconfig["xcxoff"],1)); ?>><i></i>开</label>
								</div>
							</div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
