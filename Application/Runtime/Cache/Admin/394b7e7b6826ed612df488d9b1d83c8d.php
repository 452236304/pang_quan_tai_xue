                ...
                <div class="col-sm-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                            <button class="btn btn-primary" type="button" onclick="location.href='<?php echo U('SystemMessage/modifyad','hybrid='.$map['hybrid']);?>'">＋增加</button>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12">
                                ...
                                <tbody>
                                    <?php if(is_array($data)): $n = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($n % 2 );++$n;?><tr>
                                            ...
                                            <td class="text-navy" align="center">
                                                <a href="javascript:;" data-url="<?php echo U('SystemMessage/send','id='.$vo['id'].'&p='.$map['p'].'&hybrid='.$map['hybrid']);?>"
                                                    class="J-send">推送消息</a>
                                                <a href="<?php echo U('SystemMessage/modifyad','id='.$vo['id'].'&hybrid='.$map['hybrid']);?>">修改</a>
                                                <a href="javascript:;" data-url="<?php echo U('SystemMessage/delad','id='.$vo['id'].'&p='.$map['p'].'&hybrid='.$map['hybrid']);?>"
                                                    class="checkDel">删除</a>
                                            </td>
