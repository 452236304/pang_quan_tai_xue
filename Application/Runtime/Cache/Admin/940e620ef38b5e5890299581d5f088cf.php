                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <button class="btn btn-primary" type="button"
                            onclick="location.href='<?php echo U('Business/modifyuser');?>'">＋增加</button>
                    </div>
                </div>
            </div>
            <div class="col-sm-12">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <?php if(is_array($userlist)): $i = 0; $__LIST__ = $userlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><span class="line"><?php echo ($vo["classname"]); ?></span></td>
                                        <td>
                                            <?php if($vo["ispass"] == true): ?><i class="fa fa-check"></i>
                                                <?php else: ?>
                                                <i class="fa fa-close"></i><?php endif; ?>
                                        </td>
                                        <td><?php echo (date("Y-m-d",$vo["uptime"])); ?></td>
                                        <td class="text-navy">
                                            <a href="<?php echo U('Business/modifyuser','id='.$vo['id']);?>">修改</a>
                                            <!-- <a href="<?php echo U('Business/poweruser','id='.$vo['id']);?>">权限管理</a> -->
                                            <a href="javascript:;" data-url="<?php echo U('Business/deluser','id='.$vo['id']);?>"
                                                class="checkDel">删除</a>
                                        </td>
