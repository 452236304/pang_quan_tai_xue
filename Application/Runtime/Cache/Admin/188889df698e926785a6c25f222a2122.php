            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" enctype="multipart/form-data" action="<?php echo U('About/modifyad','doinfo=modify&id='.$info['id']);?>">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="hidden" name="title" value="客服电话" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <!-- <button class="btn btn-white" type="button" onclick="location.href='<?php echo U('About/listad');?>'">返回</button> -->
                                </div>
                            </div>
                        </form>
                    </div>
