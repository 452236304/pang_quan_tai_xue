                ...
                <div class="ibox-content row">
                    <div class="col-sm-3">
                        <button class="btn btn-primary" type="button"
                                onclick="location.href='<?php echo U('CaseCate/modify');?>?keyword=<?php echo ($map["keyword"]); ?>'">＋增加</button>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <?php if(is_array($data)): $n = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($n % 2 );++$n;?><tr>
                                    ...
                                    <td class="text-navy" align="center">
                                        <p>
                                            <a href="<?php echo U('CaseCate/modify');?>?id=<?php echo ($vo['id']); ?>">修改</a>
                                            <a href="<?php echo U('CaseCate/del');?>?id=<?php echo ($vo['id']); ?>">删除</a>
                                        </p>
                                    </td>
