        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content row">
                    ...
                    <form id="search-form" method="get" class="form-horizontal" action="<?php echo U('listad','type='.$map['type']);?>?">
                        <div class="col-sm-3 row">
                            <div class="input-group">
                                <input type="text" placeholder="名称/联系电话" name="keyword" class="form-control"
                ...
                <div class="ibox-content">
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th width="100" class="TC">科目类型</th>
                            <th width="100" class="TC">学历背景</th>
                            <th width="100" class="TC">引用数</th>
                            <th width="100" class="TC">写作格式</th>
                            <th width="100" class="TC">字数数量</th>
                            <th width="100" class="TC">截止时间</th>
                            <th width="100" class="TC">用户名称</th>
                            <th width="100" class="TC">联系电话</th>
                            <th width="100" class="TC">接收邮箱</th>
                            <th width="100" class="TC">预估价格</th>
                            <th width="100" class="TC">提交时间</th>
                        ...
                        <?php if(is_array($data)): $n = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($n % 2 );++$n;?><tr>
                                ...
                                <td><?php echo ($vo["title5"]); ?></td>
                                <td><?php echo ($vo["word_num"]); ?></td>
                                <td align="center"><?php echo (date("Y-m-d H:i:s",date($vo["end_time"]))); ?></td>
                                <td><?php echo ($vo["user_name"]); ?></td>
                                <td><?php echo ($vo["user_phone"]); ?></td>
                                <td><?php echo ($vo["user_mail"]); ?></td>
                                <td><?php echo ($vo["forcase_price"]); ?></td>
                                <td align="center"><?php echo (date("Y-m-d H:i:s",date($vo["add_time"]))); ?></td>
                                <td align="center">
                                    <?php switch($vo["status"]): case "0": ?>未审核<?php break;?>
                                        <?php case "1": ?>审核成功<?php break;?>
                                        <?php case "2": ?>审核失败<?php break; endswitch;?>
                                </td>
                                <td align="center"><?php echo (date("Y-m-d H:i:s",date($vo["status_time"]))); ?></td>

                                <td class="text-navy" align="center">
                                    <p>
                                        <a href="<?php echo U('FormSubmit/modifyad','&p='.$map['p']);?>?id=<?php echo ($vo['id']); ?>">审核</a>
                                    </p>
                                </td>
