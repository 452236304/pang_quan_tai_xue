                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <button class="btn btn-primary" type="button"
                            onclick="location.href='<?php echo U('Sysuser/modifyuser');?>'">＋增加</button>
                    </div>
                </div>
            </div>
            <div class="col-sm-12">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <?php if(is_array($userlist)): $i = 0; $__LIST__ = $userlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="text-navy">
                                            <a href="<?php echo U('Sysuser/modifyuser','id='.$vo['id']);?>">修改</a>
                                            <!-- <a href="<?php echo U('Sysuser/poweruser','id='.$vo['id']);?>">权限管理</a> -->
                                            <a href="javascript:;" data-url="<?php echo U('Sysuser/deluser','id='.$vo['id']);?>"
                                                class="checkDel">删除</a>
                                        </td>
