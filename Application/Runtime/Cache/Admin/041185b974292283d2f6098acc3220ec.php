...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen  animated fadeInDown">
        <div>
            ...
            <form class="m-t" role="form" method="post" action="<?php echo U('Index/login','doinfo=userlogin');?>">
                ...
                <div class="form-group">
                    <input type="text" name="authcode" class="form-control fl" placeholder="验证码" required="" style="width:48%;">
                    <img src="<?php echo U('Public/verify');?>" class="fr verifyimg" style="width:48%; height:34px;" />
                    <div class="clb"></div>
                </div>
                <button type="submit" class="btn btn-primary block full-width m-b clb">登 录</button>
                <div class="form-group"><?php echo ($return); ?></div>
            </form>
        </div>
    </div>
