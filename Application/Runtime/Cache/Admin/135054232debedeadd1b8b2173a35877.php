                ...
                <div class="ibox-content row">
                    <div class="col-sm-3">
                        <button class="btn btn-primary" type="button"
                                onclick="location.href='<?php echo U('CaseContent/modify');?>?keyword=<?php echo ($map["keyword"]); ?>'">＋增加</button>

                    </div>
                    <form id="search-form" method="get" class="form-horizontal" action="<?php echo U('index');?>">
                ...
                <div class="ibox-content">
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th width="200" class="TC">所属分类</th>
                            <th width="100" class="TC">排序</th>
                            <th width="100" class="TC">是否显示</th>
                            <th width="100" class="TC">修改时间</th>
...
<!--                                <td align="center">-->
<!--                                    <a href="<?php echo ($vo["img_url"]); ?>" class="fancybox">-->
<!--                                        <img src="<?php echo ($vo["img_url"]); ?>" width="200" />-->
<!--                                    </a>-->
<!--                                </td>-->
                                <td align="center">
                                    <a href="<?php echo ($vo["img_url"]); ?>" class="fancybox">
                                ...
                                <td align="center"><?php echo ($vo["cate_title"]); ?></td>
                                <td align="center"><?php echo ($vo["orderby"]); ?></td>
                                <td align="center">
                                ...
                                <td class="text-navy" align="center">
                                    <p>
                                        <a href="<?php echo U('CaseContent/modify');?>?id=<?php echo ($vo['id']); ?>">修改</a>
                                        <a href="<?php echo U('CaseContent/del');?>?id=<?php echo ($vo['id']); ?>">删除</a>
                                    </p>
                                </td>
