                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" enctype="multipart/form-data"
                            action="<?php echo U('Wxcode/modifyad','doinfo=modify&id='.$info['id'].'&p='.$map['p'].'&status='.$map['status']);?>" data-id="<?php echo ($info['id']); ?>">
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">二维码<span
                                style="color:red;margin:5px;">*</span>：</label>
                        <div class="col-sm-10">
                            <input name="thumb" id="thumb" type="text" class="form-control"
                                value="<?php echo ($info["thumb"]); ?>" required="" /><br>
                            <div>
                                ...
                                <a id="thumb_Img" title="点击预览大图,点击大图关闭预览" href="<?php echo ($info["thumb"]); ?>" target="_blank">
                                    <?php if($info["thumb"] != ''): ?><img src="<?php echo ($info["thumb"]); ?>" style="max-height:100px;max-width: 100%" /><?php endif; ?>
                                </a>
								<div class="red" style="margin-top:5px;">尺寸大小为：120*120</div>
                            </div>
                        </div>
                    </div>
					<div class="hr-line-dashed"></div>
					<div class="form-group">
					    <label class="col-sm-2 control-label">备注<span style="color:red;margin:5px;">*</span>：</label>
					    <div class="col-sm-10">
                    ...
                    <div class="hr-line-dashed"></div>
					<div class="form-group">
					    <label class="col-sm-2 control-label">更新时间<span style="color:red;margin:5px;">*</span>：</label>
					    <div class="col-sm-10">
					        <input type="text" class="form-control" value="<?php echo ($info["updatetime"]); ?>" readonly="">
					    </div>
					</div>
					<div class="hr-line-dashed"></div>
                    <div class="form-group">
                        <div class="col-sm-4 col-sm-offset-2">
							<input type='hidden' name="type" value="<?php echo ($map['type']); ?>">
...
<!-- Mirrored from www.zi-han.net/theme/hplus/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Jan 2016 14:17:11 GMT -->
    ...
    <link rel="stylesheet" type="text/css" href="/Public/Home/plugin/webuploader/webuploader.css" />
    <script src="/Public/Home/plugin/webuploader/webuploader.min.js" type="text/javascript"></script>
