...
<body class="gray-bg">
    <form id="form1" name="form1" method="post" action="<?php echo U('Banner/sortad','p='.$map['p'].'&type='.$map['type'].'&notice='.$notice);?>">
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
				<?php if($map['type'] != 22 && $map['type'] != 23): ?><div class="col-sm-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                            <button class="btn btn-primary" type="button" onclick="location.href='<?php echo U('Banner/modifyad','p='.$map['p'].'&type='.$map['type'].'&notice='.$notice);?>'">＋增加</button>
                            ...
                            <table class="table table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <?php if($notice == 0): ?><th class="TC" >预览</th><?php endif; ?>
                                        <?php if($notice == 1): ?><th class="TC" width="300">公告</th><?php endif; ?>
										<th class="TC">跳转类型</th>
										<th class="TC">目标ID / 跳转链接</th>
                                ...
                                <tbody>
                                    <?php if(is_array($data)): $n = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($n % 2 );++$n;?><tr>
                                            ...
                                            <?php if($notice == 0): ?><td align="center"><a href="<?php echo ($vo["image"]); ?>" class="fancybox"><img src="<?php echo ($vo["image"]); ?>" width="100" /></a></td><?php endif; ?>
                                            <?php if($notice == 1): ?><td align="center"><?php echo ($vo["notice"]); ?></td><?php endif; ?>
											<td align="center"><?php echo ($vo["param"]["param_type"]); ?></td>
											<td align="center"><?php echo ($vo["param"]["param_id"]); ?></td>
                                            <td align="center">
                                            ...
                                            <td class="text-navy" align="center">
                                                <a href="<?php echo U('Banner/modifyad','id='.$vo['id'].'&p='.$map['p'].'&type='.$map['type'].'&notice='.$notice);?>">修改</a>
												<?php if($map['type'] != 22 && $map['type'] != 23): ?><a href="javascript:;" data-url="<?php echo U('Banner/delad','id='.$vo['id'].'&p='.$map['p'].'&type='.$map['type'].'&notice='.$notice);?>"
                                                    class="checkDel">删除</a><?php endif; ?>
                                            </td>
